...
/**
 * Abstract class representing a query handler in the Command Query Responsibility Segregation (CQRS) pattern.
 ...
 */
export abstract class QueryExecutable<TRequest extends IQuery<TResponse>, TResponse>
